    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "country",
                    models.ForeignKey(
                        to="countries_plus.Country", on_delete=models.CASCADE
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "iso_639_1",
                    models.CharField(max_length=2, serialize=False, primary_key=True),
                ),
                ...
                (
                    ...
                    models.ManyToManyField(
                        to="countries_plus.Country", null=True, blank=True
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                to="languages_plus.Language", on_delete=models.CASCADE
            ),
