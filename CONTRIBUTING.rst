...
Report bugs at https://github.com/cordery/django-languages-plus/issues.
...
The best way to send feedback is to file an issue at https://github.com/cordery/django-languages-plus/issues.
...
Ready to contribute? Here's how to set up `django-languages-plus` for local development.

1. Fork the `django-languages-plus` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/django-languages-plus.git
